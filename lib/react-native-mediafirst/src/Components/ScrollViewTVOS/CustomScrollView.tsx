...
import { Animated, findNodeHandle, Platform, StyleSheet, View } from "react-native";

import { PressEvent } from "CoreEventTypes";
import { EdgeInsetsProp } from "EdgeInsetsPropType";
import { NativeMethodsMixinType } from "ReactNativeTypes";
import { ViewStyleProp } from "StyleSheet";
import { ViewProps } from "ViewPropTypes";
import { PointProp } from "PointPropType";

import { ColorValue } from "StyleSheetTypes";

let AndroidScrollView:any;
let GAndroidScrollView:any;
let AndroidHorizontalScrollContentView:any;
let AndroidHorizontalScrollView :any;
let GAndroidHorizontalScrollView:any;
let RCTScrollView :any;
let RCTScrollContentView:any;
if (Platform.OS === "android") {
    AndroidScrollView = "RCTScrollView";
    AndroidHorizontalScrollView = "AndroidHorizontalScrollView";
    AndroidHorizontalScrollContentView = requireNativeComponent("CustomAndroidHorizontalScrollContentView");
    GAndroidHorizontalScrollView = requireNativeComponent("GAndroidHorizontalScrollView");
    GAndroidScrollView = requireNativeComponent("GAndroidVerticalScrollView");
...
interface TouchableProps {
    readonly onTouchStart?: (event: PressEvent) => void;
    readonly onTouchMove?: (event: PressEvent) => void;
    readonly onTouchEnd?: (event: PressEvent) => void;
    readonly onTouchCancel?: (event: PressEvent) => void;
    readonly onTouchEndCapture?: (event: PressEvent) => void;
}
...
interface IOSProps {
     ...
     * @platform ios
     */
    readonly indicatorStyle?: "default" | "black" | "white";
    /**
...
interface VRProps {
     ...
     * @platform vr
     */
    readonly scrollBarThumbImage?: {} | number; // Opaque type returned by import IMAGE from './image.jpg'
}

export interface Props extends ViewProps, TouchableProps, IOSProps, AndroidProps, VRProps {
    /**
...
const ScrollView = createReactClass({
     ...
     */
    getScrollResponder: function(): any {
        return this;
    },
     ...
     */
    scrollTo: function(y?: number | { x?: number; y?: number; animated?: boolean }, x?: number, animated?: boolean) {
        if (typeof y === "number") {
            console.warn(
    ...
    _scrollViewRef: function(_null: ScrollView) {},
    _setScrollViewRef: function(ref: ScrollView) {
        this._scrollViewRef = ref;
    },

    _innerViewRef: function(_null: NativeMethodsMixinType) {},
    _setInnerViewRef: function(ref: NativeMethodsMixinType) {
        this._innerViewRef = ref;
    },
    absoluteChildren: function(childArray: Object) {
    ...
    render: function() {
        ...
        if (Platform.OS === "android") {
            if (this.props.horizontal) {
                ...
                ScrollViewClass = GAndroidHorizontalScrollView;
                ScrollContentContainerViewClass = Animated.createAnimatedComponent(AndroidHorizontalScrollContentView);
                // ScrollContentContainerViewClass = AndroidHorizontalScrollContentView;
            } else {
                // ScrollViewClass = AndroidScrollView;
                ScrollViewClass = GAndroidScrollView;
            ...
            if (this.props.horizontal) {
                ...
                ScrollContentContainerViewClass = Animated.createAnimatedComponent(RCTScrollContentView);
            } else {
                ScrollContentContainerViewClass = RCTScrollContentView;
            }
        }
        ...
        const contentContainer = (
            <ScrollContentContainerViewClass
                ...
                removeClippedSubviews={
                    ...
                    Platform.OS === "android" && hasStickyHeaders ? false : this.props.removeClippedSubviews
                }
                collapsable={false}
            >
                {children}
        ...
        const alwaysBounceHorizontal =
            this.props.alwaysBounceHorizontal !== undefined ? this.props.alwaysBounceHorizontal : this.props.horizontal;

        const alwaysBounceVertical =
            this.props.alwaysBounceVertical !== undefined ? this.props.alwaysBounceVertical : !this.props.horizontal;
        ...
        const props = {
            ...
            pagingEnabled: Platform.select({
                ...
                android:
                    this.props.pagingEnabled || this.props.snapToInterval != null || this.props.snapToOffsets != null,
            }),
        };
...
const TypedScrollView = ScrollView;
